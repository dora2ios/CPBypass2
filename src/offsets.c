...
offsets_init(void){
    ...
    if (strcmp(u.version, "Darwin Kernel Version 20.0.0: Fri Aug 28 23:05:58 PDT 2020; root:xnu-7195.0.46~9/RELEASE_ARM64_S8000") == 0 ||
        ...
        _payload_base       = OFFSET(0xfffffff0077436d0);
    } else if (strcmp(u.version, "Darwin Kernel Version 18.7.0: Mon Nov  9 15:07:15 PST 2020; root:xnu-4903.272.3~3/RELEASE_ARM64_S5L8960X") == 0) {
        /*---- s5l8960x 16H22 [12.5.1] ----*/
        ml_phys_read_data   = OFFSET(0xfffffff007750fbc);
        ml_phys_write_data  = OFFSET(0xfffffff0077512b0);
        _sysent_stat        = OFFSET(0xfffffff0073dd1e0);
        _copyinstr          = OFFSET(0xfffffff007749dd0);
